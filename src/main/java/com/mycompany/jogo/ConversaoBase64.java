...
public class ConversaoBase64 {
    ...
    //Perguntas do Jogo
    private static String perguntaQuestao1Fase1Caminho = "PerguntaQuestao1Fase1.png";
    ...
    //Itens do Jogo
    private static String item1Questao1Fase1Caminho = "Item1Questao1Fase1.png";
    private static String item2Questao1Fase1Caminho = "Item2Questao1Fase1.png";
    private static String item3Questao1Fase1Caminho = "Item3Questao1Fase1.png";
    private static String item4Questao1Fase1Caminho = "Item4Questao1Fase1.png";
    ...
    public void main(String[] args) throws IOException{
        ...
        byte[] perguntaQuestaoFoto = Base64.getDecoder().decode(perguntaQuestaoString);
        ...
        byte[] item1QuestaoFoto = Base64.getDecoder().decode(item1QuestaoString);
        ...
        byte[] item2QuestaoFoto = Base64.getDecoder().decode(item2QuestaoString);
        ...
        byte[] item3QuestaoFoto = Base64.getDecoder().decode(item3QuestaoString);
        ...
        byte[] item4QuestaoFoto = Base64.getDecoder().decode(item4QuestaoString);
        
        System.out.println(item1QuestaoString);
